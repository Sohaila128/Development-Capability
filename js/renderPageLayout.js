    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="text-center align-items-center">
          ...
          <a href="https://www.linkedin.com/in/sohaila-abo-el-wafa-a2b417248/" target="_blank" class="text-warning text-decoration-none fw-semibold fs-7"> <span class="text-white">بواسطة</span> Sohaila Abo El-Wafa </a>
        </div>
    </div>
  </footer>
  `);
